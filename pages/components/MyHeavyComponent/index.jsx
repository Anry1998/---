...
function MyHeavyComponent() {
    ...
    // использую useMemo в месте, где вызывается вункция долгих вычислений
    // и указываю currentNum как значение при изменении которой необходимо запускать функцию
